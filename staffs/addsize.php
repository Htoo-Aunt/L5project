...
if (isset($_POST['rolesub'])) {
	...
	$check="SELECT * FROM sizes WHERE Size='$rolename'";
	$run=mysqli_query($connect,$check);
	$count=mysqli_num_rows($run);

	if ($count>0) {

		echo"<script>window.alert('Category already exist')</script>";
		  header("Refresh:0");
		}
		
	else{
	
		$insert=" INSERT INTO sizes(`Size`,`CategoryID`) VALUES ('$rolename','$cat')";
...
<li>
<a href="addsize.php" class="active">Add Sizes</a>
</li>
...
<h4>Add Product Sizes</h4>
<h6>Create new Sizes</h6>
</div>
</div>
