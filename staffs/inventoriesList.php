...
$check="SELECT i.*,p.* FROM inventory i,products p WHERE i.ProductID=p.ProductID";
...
<div class="page-btn">
<a href="addinventories.php" class="btn btn-added">
<img src="../assets/img/icons/plus.svg" class="me-1" alt="img" width="30px">Add Inventories
</a>
</div>
</div>
...
<td>
<a class="me-3" href="invedit.php?invid='.$row["InvID"].'">
