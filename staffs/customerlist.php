...
<h4>Customer list</h4>
<h6>Choose your Customers to create an order</h6>
</div>
<div class="page-btn">
<a href="addcustomers.php" class="btn btn-added">
<img src="../assets/img/icons/plus.svg" class="me-1" alt="img" width="30px">Create new Customers
</a>
</div>
</div>
...
<label class="checkboxs">
 <input type="checkbox" name="selected_customer" value="'.$row["CustomerID"].'" onchange="this.form.submit()">
