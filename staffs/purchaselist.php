...
$check="SELECT p.*,s.*,st.* FROM purchase p,suppliers s,staffs st WHERE p.SupplierID=s.SupplierID AND p.StaffID=st.StaffID";
...
<h4>Purchase list</h4>
<h6>View/Search Purchase records</h6>
</div>
<div class="page-btn">
<a href="addpurchase.php" class="btn btn-added">
<img src="../assets/img/icons/plus.svg" class="me-1" alt="img" width="30px">Add Purchase
</a>
</div>
</div>
...
<td>'.$row["Bname"].'</td>
<td>'.$row["StaffName"].'</td>
<td>'.$row["totalPurchasePrice"].'</td>
<td style="color:red;">'.$row["PurStatus"].'</td>



<td> 
<a class="me-3" data-bs-toggle="tooltip" data-bs-placement="top" title="view" href="purchaseconfirm.php?purid='.$row["PurchaseID"].'">
