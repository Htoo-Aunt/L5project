...
if (isset($_POST['rolesub'])) {
    ...
    $des=$_POST['proDes'];
    $avs=$_POST['proAvsz'];
	$check="SELECT * FROM products WHERE ProductName='$rolename' AND SKU='$sku'";
	...
	if ($count>0) {
		...
		$insert=" INSERT INTO products (`ProductName`, `ProductPhoto`, `ProductPhoto2`, `Description`, `SKU`,`AvailSizes`, `CategoryID`) VALUES ('$rolename','$FileName','$FileName1','$des','$sku','$avs','$cat')";
...
<li>
<a href="addproduct.php" class="active">Add Products</a>
</li>
<li>
...
for ($i=0; $i < $count; $i++) { 
    ...
    $rolID=$row['CategoryID'];
    $rolName=$row['Category'];
...
<input type="text" name="proDes" required>
</div>
</div>
<div class="col-lg-4 col-sm-6 col-12">
<div class="form-group">
<label>SKU</label>
<input type="text" name="proSKU" placeholder="enter product/color" required>
</div>
</div>
<div class="col-lg-4 col-sm-6 col-12">
<div class="form-group">
<label>Available Sizes</label>
<input type="text" name="proAvsz" placeholder="For example// 36 to 40" required>
</div>
</div>
