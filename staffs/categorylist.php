...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($confirmation === 'confirmed') {
      $del="DELETE FROM category WHERE CategoryID='$sessionId' ";
...
<h6>View/Search available categories</h6>
</div>
<div class="page-btn">
<a href="addsupplier.php" class="btn btn-added">
<img src="../assets/img/icons/plus.svg" class="me-1" alt="img" width="30px">Add Category
</a>
</div>
</div>
...
<a class="me-3 confirm"  name="btndel" onclick="confirmDelete('.$row["CategoryID"].');">
     ...
     function confirmDelete(catID) {
            ...
            if (userConfirmed) {
                $.ajax({
                    ...
                    data: { confirmation: "confirmed", session_id: catID },
