...
$check="SELECT o.*,c.*,do.* FROM orders o,deliveryorders do,customers c WHERE o.OrderID=do.OrderID AND o.CustomerID=c.CustomerID";
...
<h6>View/Search Delivery records</h6>
</div>
...
<td style="color:red;">'.$row["DeliStatus"].'</td>



<td> 
<a class="me-3" data-bs-toggle="tooltip" data-bs-placement="top" title="update" href="deliConfirm.php?did='.$row["DeliveryID"].'">
<img src="../assets/img/icons/updatests.svg" alt="img" width="22" >
</a>
