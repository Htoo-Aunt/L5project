...
$show="SELECT p.*,c.* FROM products p, category c WHERE p.ProductID='$pid' AND p.CategoryID=c.CategoryID";
...
<img src="<?php echo $row['ProductPhoto'] ?>" alt="img">
<h4><?php echo $row['ProductName']; ?>.jpg</h4>

</div>
<div class="slider-product">
<img src="<?php echo $row['ProductPhoto2'] ?>" alt="img">
<h4><?php echo $row['ProductName'] ?>.jpg</h4>
