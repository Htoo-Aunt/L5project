...
$check="SELECT o.*,c.*,st.* FROM orders o,customers c,staffs st WHERE o.CustomerID=c.CustomerID AND o.StaffID=st.StaffID";
...
<h4>Order list</h4>
<h6>View/Search Order records</h6>
</div>
<div class="page-btn">
<a href="customerlist.php" class="btn btn-added">
<img src="../assets/img/icons/plus.svg" class="me-1" alt="img" width="30px">Add Orders
</a>
</div>
</div>
...
<td style="color:red;">'.$row["OrderStatus"].'</td>



<td> 
<a class="me-3" data-bs-toggle="tooltip" data-bs-placement="top" title="view" href="orderconfirm.php?ordid='.$row["OrderID"].'">
<img src="../assets/img/icons/eye.svg" alt="img" width="22" >
</a>
<a class="me-3" data-bs-toggle="tooltip" data-bs-placement="top" title="Delivery" href="addDeli.php?delid='.$row["OrderID"].'">
<img src="../assets/img/icons/delivery.svg" alt="img" width="22" >
</a>
