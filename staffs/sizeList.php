...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && $confirmation === 'delete') {
    ...
    if ($confirmation === 'delete') {
      $del="DELETE FROM sizes WHERE SizeID='$sessionId' ";
...
$check="SELECT s.*,c.* FROM sizes s,category c WHERE s.CategoryID=c.CategoryID";
...
<li>
<a href="sizeList.php" class="active">Size List</a>
</li>
<li>
...
<h4>Product Size Lists</h4>
<h6>View/Search available Sizes</h6>
</div>
<div class="page-btn">
<a href="addsize.php" class="btn btn-added">
<img src="../assets/img/icons/plus.svg" class="me-1" alt="img" width="30px">Add Sizes
</a>
</div>
</div>
...
<a class="me-3 confirm"  name="btndel" onclick="confirmDelete('.$row["SizeID"].');">
...
<script>
     ...
     function confirmDelete(catID) {
            ...
            var confirmMessage = "Are you sure you want to delete with session ID " + catID + "?";
            ...
            if (userConfirmed) {
                $.ajax({
                    type:"POST",
                    url: "sizeList.php",
                    data: { confirmation: "delete", session_id: catID },
