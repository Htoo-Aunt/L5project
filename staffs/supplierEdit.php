...
$suid=$_GET['suid'];
$show="SELECT * FROM suppliers WHERE SupplierID='$suid'";
...
if (isset($_POST['supUpd'])) {
    ...
    $insert="UPDATE `suppliers` SET `Bname`='$rolename',`Pname`='$cat',`Contact`='$sku',`Location`='$des',`Source`='$avs',`supstatus`='$sts' WHERE `SupplierID`='$id'";
...
<ul>
	...
	<li>
<a href="supplierlist.php" class="active">Suppliers List</a>
</li>
<li>
...
<div class="page-title">
    ...
    <a href="supplierlist.php" class="btn btn-cancel" style="margin-bottom: 20px;">Back</a>
<h4>Edit Supplier</h4>
<h6>Edit Suppliers' Info</h6>
</div>
</div>
...
<input type="text" name="supBname" value="<?php echo $row['Bname'] ?>" required>
</div>
</div>
...
<input type="text" name="supPname" value="<?php echo $row['Pname'] ?>" required>
</div>
</div>
<div class="col-lg-4 col-sm-6 col-12">
<div class="form-group">
<label>Contact</label>
<input type="text" name="supCon" value="<?php echo $row['Contact'] ?>" required>
</div>
</div>
<div class="col-lg-4 col-sm-6 col-12">
<div class="form-group">
<label>Supply Location</label>
<input type="text" name="supLoc" value="<?php echo $row['Location'] ?>" required>
</div>
</div>
<div class="col-lg-4 col-sm-6 col-12">
<div class="form-group">
<label>Supply Source</label>
<input type="text" name="supSource" value="<?php echo $row['Source'] ?>" required>
</div>
</div>
...
if ($row['supstatus']==='Active') {
    

            echo '<input type="radio" name="supstatus" value="Active" checked>Active

            <input type="radio" name="supstatus" value="Unactive" style="margin-left: 20px;">Unactive';
            }

            else{

                echo '<input type="radio" name="supstatus" value="Active">Active

            <input type="radio" name="supstatus" value="Unactive" style="margin-left: 20px;" checked>Unactive';
...
<input type="text" name="updProid" value="<?php echo  $row['SupplierID'] ?>" readonly hidden>
