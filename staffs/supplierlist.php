...
<li>
<a href="supplierlist.php" class="active">Supplier List</a>
</li>
<li>
...
<h4>Supplier list</h4>
<h6>View/Search available Suppliers</h6>
</div>
<div class="page-btn">
<a href="addsupplier.php" class="btn btn-added">
<img src="../assets/img/icons/plus.svg" class="me-1" alt="img" width="30px">Add Suppliers
</a>
</div>
</div>
...
<td>
<a class="me-3" href="supplieredit.php?suid='.$row["SupplierID"].'">
...
<script>
     ...
     function confirmDelete(supplierID) {
        // Use JavaScript's built-in confirm dialog
        var confirmResult = confirm("Are you sure you want to delete Supplier ID " + supplierID + "?");

        if (confirmResult) {
            // If the user confirms, make an AJAX request to delete the record
            $.ajax({
                type: "POST",
                url: "deleteSuppliers.php", // Replace with the actual path to your delete script
                data: {
